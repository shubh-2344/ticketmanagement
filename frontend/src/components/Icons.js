...
// Common SVG Wrapper
const SvgIcon = ({ children, size = 20, className = '', style = {}, viewBox = '0 0 24 24', ...props }) => (
  <svg
...
export const InventoryIcon = (props) => (
  <SvgIcon {...props}>
    ...
    <polyline points="12 3 21 8 12 13 3 8 12 3" />
  </SvgIcon>
);
...
export const LogoIcon = ({ size = 32, ...props }) => (
  <SvgIcon size={size} viewBox="0 0 24 24" strokeWidth="2.5" {...props}>
